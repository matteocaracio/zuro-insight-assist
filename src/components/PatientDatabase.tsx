...
const mockPatients = [
  {
    ...
    status: "Ativo",
    notes: [
      { date: "2023-04-28", content: "Paciente relatou melhora significativa na mobilidade após 3 sessões." },
      { date: "2023-03-15", content: "Iniciou tratamento para dor lombar crônica. Recomendado exercícios diários." }
    ],
    files: [
      { name: "Exame Raio-X.pdf", date: "2023-03-10", type: "application/pdf" },
      { name: "Avaliação Inicial.pdf", date: "2023-03-01", type: "application/pdf" }
    ]
  },
  {
    id: 2,
    ...
    status: "Ativo",
    notes: [
      { date: "2023-05-02", content: "Realizados exercícios de fortalecimento. Paciente apresentou evolução na propriocepção." }
    ],
    files: [
      { name: "Ressonância Magnética.pdf", date: "2023-04-20", type: "application/pdf" }
    ]
  },
  {
    id: 3,
    ...
    status: "Inativo",
    notes: [
      { date: "2023-04-18", content: "Paciente completou tratamento. Alta médica concedida." }
    ],
    files: []
  }
];
...
const PatientDatabase = () => {
  ...
  const handleSearchCPF = () => {
    const formattedCPF = searchCPF.replace(/\D/g, '')
      .replace(/(\d{3})(\d)/, '$1.$2')
      .replace(/(\d{3})(\d)/, '$1.$2')
    ...
    const updatedPatients = patients.map(p => {
      if (p.id === currentPatient.id) {
        return {
          ...p,
          notes: [
            { date: new Date().toISOString().split('T')[0], content: newNote },
            ...p.notes
          ]
        };
      }
          ...
          <Card className="shadow-md">
            <CardHeader className="pb-2">
              <div className="flex justify-between items-start">
                ...
                <Badge 
                  variant={currentPatient.status === "Ativo" ? "default" : "secondary"}
                  className={currentPatient.status === "Ativo" ? "bg-green-500" : "bg-gray-500"}
                >
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Button 
                        ...
                        className="bg-zuro hover:bg-zuro-dark text-white mt-2"
                      >
                    ...
                    <div className="space-y-3 mt-6">
                      ...
                      {currentPatient.files.length === 0 ? (
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                          {currentPatient.files.map((file: any, index: number) => (
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button size="sm" className="bg-zuro hover:bg-zuro-dark text-white">
                  <Plus className="h-4 w-4 mr-1" />
                  Novo Paciente
                </Button>
              </DialogTrigger>
                    ...
                    <TableRow key={patient.id}>
                      ...
                      <TableCell>
                        <Badge 
                          ...
                          className={patient.status === "Ativo" ? "bg-green-500" : "bg-gray-500"}
                        >
                          {patient.status}
                        </Badge>
                      </TableCell>
